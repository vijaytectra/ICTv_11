...
print("==========================================================================")
print("     BACKTEST RUNNER — SPECIFIC DATASET (2026.09.05 to 2026.09.17)        ")
print("==========================================================================")
print("Codebase Status: UNCHANGED AS-IS")
print("Target Pairs:   ", ", ".join(user_pairs))
print("==========================================================================")

def load_specific_recent_data(data_dir: str, pair: str) -> pd.DataFrame:
    """Loads strictly the 2026.09.05_2026.09.17 Bid and Ask CSV files for a pair."""
...
for pair in user_pairs:
    ...
    try:
        ...
        print(f"    Raw 1m rows: {len(df_raw)} | Resampled 5m candles: {len(df_5m)}")
...
print("\n==========================================================================")
print("                   PAIR PERFORMANCE SUMMARY TABLE                         ")
print("==========================================================================")
df_pairs_report = pd.DataFrame(pair_summaries)
print(df_pairs_report.to_string(index=False))

print("\n==========================================================================")
print("                 PORTFOLIO OVERALL BACKTEST SUMMARY                       ")
print("==========================================================================")
...
print(f"Overall Portfolio Win Rate:     {win_rate:.2f}% ({num_wins} Wins / {num_losses} Losses)")
print(f"Portfolio Profit Factor:        {profit_factor:.2f}")
print(f"Net Portfolio Profit:           ${net_pnl:+.2f} ({return_pct:+.2f}% Return)")
print(f"Final Combined Balance:         ${ending_capital:.2f}")

print("\n----------------------------------------------------------------------------------------")
print("Setup #  Setup Name                                    Trades   Wins   Losses   Win Rate %   Net PnL ($)")
print("----------------------------------------------------------------------------------------")
...
print(pd.DataFrame(setup_report).to_string(index=False))
print("================================================================------------------------\n")
